...
class Registraciya extends Model
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'captcha' => 'Введите буквы с картинки',
        ];
    }
    ...
    public function rules()
    {
        return [
            ...
            ['rabotaEtapObrazovaniya', 'required'],
            ...
            ['captcha', CaptchaValidator::className(), 'message' => 'Введённые вами буквы не совпадают с буквами на картинке.']
        ];
    }
    ...
    private function registerImpl()
    {
        ...
        $polzovatel = new Polzovatel([
            ...
            'parol' => $this->parol,
            'aktiven' => false,
            'roliAsArray' => [Rol::PEDAGOGICHESKIJ_RABOTNIK]
        ]);
        ...
        $message = Yii::$app->mailer
            ->compose('polzovatel/registraciya', [
                'model' => $this,
