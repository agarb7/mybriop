...
class m160926_140013_itogovyi_otchet_new_parametr extends Migration
{
    public function up()
    {
        $sql = <<<SQLDELETE
DROP FUNCTION IF EXISTS attestaciya_itogovij_otchet(vremya_provedeniya_param bigint)
SQLDELETE;
        $this->execute($sql);
        $sql = <<<SQL
...
SQL;
    ...
    {
        echo "m160926_140013_itogovyi_otchet_new_parametr cannot be reverted.\n";
