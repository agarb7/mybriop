...
class m180212_123506_blokirovanie_zayavleniya_na_attestaciyu extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->insert('lock_zayavleniya_na_attestaciyu',[
            ...
            'text' => \app\globals\ApiGlobals::to_trimmed_text('Вами не были предоставлены аттестационные материалы в установленные сроки. Если Вы планируете проходить аттестацию в дальнейшем, Вам необходимо заново подать заявление.')
        ]);
    }
