...
class m171108_064709_alter_rabotajushhie_sotrudniki_briop extends Migration
{
    public function up()
    {
...
SQL;
    ...
    {
        echo "m171108_064709_alter_rabotajushhie_sotrudniki_briop cannot be reverted.\n";
