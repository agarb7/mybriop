...
class m161202_073023_otsenki_function_include_insigned_marks extends Migration
{
    public function up()
    {
        $sql = <<<SQL
...
SQL;
    ...
    {
        echo "m161202_073023_otsenki_function_include_insigned_marks cannot be reverted.\n";
