...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <p>На основании <?echo $prikaz->atributy[7]?> по программе "<?echo $nazvanie?>" для категории слушателей "<?echo $prikaz->atributy[3]?>" в объеме <?echo $prikaz->atributy[4]?> часов с <?echo $prikaz->atributy[5]?>г. по <?echo $prikaz->atributy[6]?>г.</p>
        <p><b>ПРИКАЗЫВАЮ:</b></p>
