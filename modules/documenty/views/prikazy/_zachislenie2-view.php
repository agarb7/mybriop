...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <p>На основании заявлений педагогических работников образовательных организаций Республики Бурятия о зачислении на курсы по программе "<?echo $nazvanie?>" для категории слушателей "<?echo $prikaz->atributy[3]?>" в объеме <?echo $prikaz->atributy[4]?> часов с <?echo $prikaz->atributy[5]?>г. по <?echo $prikaz->atributy[6]?>г.</p>
        <p><b>ПРИКАЗЫВАЮ:</b></p>
