...
<p>Аттестация на: <?=KategoriyaPedRabotnika::namesMap()[$zayavlenie->na_kategoriyu]?></p>
    ...
    <? $k=1; for($i=0;$i<$colexp;$i++):$n=$i+1;if($total[$i]>0):?>
        ...
        <?$k++;endif;endfor; ?>
<?} else echo"<h3>Оценочные листы ИК не имеют оценок!!!</h3> Для формирования нового оценочного листа ИК эксперта требуется удалить все неправильно оцененные листы и провести повторную экспертизу.";?>
